...
CREATE TABLE chatmessage(
   ...
   cm_m_id varchar2(20) NOT NULL,
   cm_text varchar2(100) NOT NULL,
...
CREATE TABLE townNews(
   ...
   t_m_id varchar2(20) NOT NULL,
   t_title varchar2(50) NOT NULL,
   t_text varchar2(500) NOT NULL,
   t_photo varchar2(50),
...
CREATE TABLE townNews_reply(
   ...
   tr_m_id varchar2(20) NOT NULL,
   tr_text varchar2(100) NOT NULL,
...
CREATE TABLE report(
   ...
   r_m_writerId varchar2(20) NOT NULL,
   r_m_reportedId varchar2(20) NOT NULL,
   r_category varchar2(20) NOT NULL,
   r_text varchar2(500) NOT NULL,
   r_photo varchar2(20),
